...
import reducersHelpPage from './store/reducers';
import WrapHelpPage from './style';

interface Props {}

// eslint-disable-next-line
function HelpPage({}: Props) {
  useInjectReducer('HelpPage', reducersHelpPage);
  return (
    <ErrorBound>
      <WrapLayout>
        <WrapHelpPage>
                ...
                <div className="col-12 col-md-6">
                  <div className="faq">
                    ...
                    <p className="faq__text">
                      ...
                      first true generator on the Internet. Various versions
                  ...
                  <div className="faq">
                    <h3 className="faq__title">
                      Why is the Video stuttering, buffering or randomly
                      stopping?
                    </h3>
                    <p className="faq__text">
